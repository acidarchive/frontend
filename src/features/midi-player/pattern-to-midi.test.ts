...
import { stepsToMessages } from '@/features/midi-player/pattern-to-midi-fsm';
...
describe('parseStep', () => {
  it('should parse a steps', () => {
    ...
    expect(parsed).toEqual([
      { gate: true, pitch: 36, slide: true, velocity: 70 },
      { gate: true, pitch: 36, slide: false, velocity: 70 },
      { gate: false },
      { gate: true, pitch: 38, slide: false, velocity: 70 },
    ]);
  });
