...
import { GridSwitch } from '@/app/components/atoms/grid-switch';
import { WaveformSelect } from '@/app/components/atoms/waveform-select';

export function SettingsTB303() {
  return (
    <div className="flex flex-row  items-center border-t border-gray-200 divide-x justify-start  divide-gray-200">
      ...
      <div className="h-full flex flex-1 items-center py-2 px-4 gap-4">
        <span className=""></span>
      </div>
    </div>
  );
