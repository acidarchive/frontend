...
import { ReadonlyControlsTB303 } from '@/app/components/molecules/readonly-controls-tb303';
import { ReadonlyPatternHeader } from '@/app/components/molecules/readonly-pattern-header';
import { ReadonlySequencerTB303 } from '@/app/components/molecules/readonly-sequencer-tb303';
import { ReadonlySettingsTB303 } from '@/app/components/molecules/readonly-settings-tb303';
...
export function ReadonlyTB303PatternGrid({
  ...
  return (
    <div className="grid sm:grid-rows-[auto_6fr_5fr_auto] grid-rows-[auto] border border-gray-950 relative">
      ...
      <div className="p-4">{pattern?.description}</div>
