...
import { EditableTB303PatternDetails } from '@/app/components/organisms/editable-tb303-pattern-details';
import { EditableTB303PatternGrid } from '@/app/components/organisms/editable-tb303-pattern-grid';
    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <div className="-mx-4 shadow-xs sm:mx-0  lg:col-span-2 lg:row-span-2 lg:row-end-2">
